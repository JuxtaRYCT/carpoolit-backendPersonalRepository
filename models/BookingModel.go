...
type Booking struct {
	...
	RequestStatus string `gorm:"type:varchar(10);not null" json:"request_status" valid:"in(accepted|pending|rejected)~Request Status is either accepted, pending or rejected,required~Status is Required"`
}
